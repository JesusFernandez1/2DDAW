    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="index.php?controller=tareas&action=inicio" class="nav-link px-2 text-secondary">Inicio</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\2DAW\CursoPHP\AProyecto\app\views/header.blade.php ENDPATH**/ ?>