   ...
   <table class="table">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><a href="index.php?controller=tareas&action=ModificarUnaTarea&id=<?php echo e($tarea['tarea_id']); ?>" class="btn btn-primary btn-sm" role="button">Modificar</a> <a href="index.php?controller=tareas&action=delete&id=<?php echo e($tarea['tarea_id']); ?>" class="btn btn-primary btn-sm" role="button">Eliminar</a>
